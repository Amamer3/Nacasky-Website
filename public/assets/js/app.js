...
;(function ($) {
  ...
  /*--------------------------------------------------------------
    ...
    Nacasky PRELOADER JS INIT
    Nacasky HEADER SEARCH JS INIT
    Nacasky STICKY MENU JS INIT
    Nacasky MENU SIDEBAR JS INIT
    Nacasky SKILLBAR JS INIT
    Nacasky HERO SLIDER INIT
    Nacasky FOUR COLUMN SLIDER INIT
    Nacasky THREE COLUMN SLIDER INIT
    Nacasky FOUR COLUMN SLIDER TWO INIT
    Nacasky TWO COLUMN SLIDER INIT
    Nacasky ONE COLUMN SLIDER INIT
    Nacasky THREE COLUMN SLIDER TWO INIT
    Nacasky BRAND SLIDER INIT
    Nacasky COUNTER JS INIT
    Nacasky COUNTER JS TWO INIT
    Nacasky MAP JS
  ...
  if (google_map.is_exist()) {
    var init = function init () {
      ...
      var contentString =
        '<div id="content">' + '<div id="tpw">' + '<h3>optech' + '</div>'
